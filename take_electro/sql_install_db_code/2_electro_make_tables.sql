...
INSERT INTO locations VALUES            -- пример заполнения данными
...
INSERT INTO temp_current VALUES         -- пример заполнения данными
...
CREATE TABLE temp_changes_archive (     -- архив фиксации изменений
