...
#~ set terminal postscript enhanced "Helios Cond.ttf" 8
#~ set terminal postscript "Helios Cond.ttf" eps enhanced color fontfile "/usr/share/fonts/truetype/helios/Helios Cond.ttf"
...
#~ plot  "$TMP_DIR/$1.txt" using 1:3 with line linestyle 1, \
      #~ "$TMP_DIR/$1.txt" using 1:2 with line linestyle 2
