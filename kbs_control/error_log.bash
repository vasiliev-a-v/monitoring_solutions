#!/bin/bash
#~ скрипт отображает когда отключилась базовая станция на КБС
...
_LOG=$( tac "$error_log" | head -n 8 )	#~ файл журнала
_SITE=""
...
_SITE="
<html>
<meta http-equiv=refresh content=29,url=http://$SERVER_ADDR$SCRIPT_NAME?$QUERY_STRING>
<title>Журнал перезапуска процесса g2 и перезагрузки КБС</title>
